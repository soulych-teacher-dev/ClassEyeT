...
| 어디에 설치? | 어떻게? |
|---|---|
| **교사 PC** | 아래 [Releases](../../releases/latest) 에서 `ClassEyeT-Setup-x.x.x.exe` 다운로드 |
...
1. [Releases](../../releases/latest) 에서 `ClassEyeT-Setup-x.x.x.exe` 다운로드
2. 실행 → 설치 마법사 따라 진행
3. 교사 앱 실행
...
기본값은 `C:\ClassEyeT\녹화\` 입니다. 설정에서 변경할 수 있습니다.
...
📧 **문의·버그 제보**: [vangogh@sen.go.kr](mailto:vangogh@sen.go.kr)

(교사 신원 확인이 필요한 문의는 반드시 교육청(`*.go.kr`) 이메일로 보내주세요.)
